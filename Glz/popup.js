...
var YTapi = {
  ...
  searchURL:'https://www.googleapis.com/youtube/v3/search?order=rating&part=snippet&maxResults=5&q='
};
/**
...
document.addEventListener('DOMContentLoaded', function() {
  getCurrentTabUrl(function(url, tab) {
    ...
    if(url.indexOf(".glgltz.co.il") >0)
    {
      renderStatus('found glgltz, parsing page');
      getImageUrl(url, function(imageUrl, width, height) {
        renderStatus('done!');
      });
    }
    else{
      renderStatus('not glgltz');
    }
